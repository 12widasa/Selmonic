...
<div class="picsort text-center">
    <h1>Welcome to PicSort</h1>
    <p>Identify the freshness of vegetables using your webcam.</p>
    <div id="canvas"></div>
</div>
...
<script>
    ...
    navigator.mediaDevices
        ...
        .then(function(stream) {
            ...
            roboflow
                .auth({
                    publishable_key: "rf_jiIhzsm6eOMeq514VUXJ0NjqOkk1",
                })
                .load({
                    model: "selada-1y6sd",
                    version: 1,
