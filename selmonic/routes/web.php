...
use App\Http\Controllers\Admin\Controlling;
...
use App\Http\Controllers\PicsortController;
...
Route::get('/picsort', [PicsortController::class, 'index'])->name('picsort');
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::get('controlling', [Controlling::class, 'showPage'])->name('controlling.show');
});
